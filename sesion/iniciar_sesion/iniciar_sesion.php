...
<form class="form-signin">
	...
	<button class="btn btn-large btn-primary" type="submit" onclick="g('sesion/iniciar_sesion/iniciar_sesion_ajax.php?'+a('iniciar_sesion')+v('dni')+v('password'),'#resultado'); return false;">Ingresar</button>
</form>
