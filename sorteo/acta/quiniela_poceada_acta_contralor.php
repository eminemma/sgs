...
$pozo_5_aciertos = (($row_rec->CANTIDAD_GANADORES_5 == 0) ? 'Pozo Vacante con 5 Aciertos' : ($row_rec->CANTIDAD_GANADORES_5 > 1 ? $row_rec->CANTIDAD_GANADORES_5 . ' Ganadores con $' . number_format(($row_rec->MONTO_FRACCION), 2, ',', '.') . ' c/u, 5 Aciertos ' : $row_rec->CANTIDAD_GANADORES_5 . ' Ganador con $' . number_format(($row_rec->MONTO_FRACCION), 2, ',', '.') . ', 5 Aciertos  '));
$pdf->ln(10);
$pdf->SetX(25);
...
$pdf->SetX(25);
$pdf->Cell(160, 5, $pozo_5_aciertos, 1, 1, 'C');
if ($reportePDF === false) {
