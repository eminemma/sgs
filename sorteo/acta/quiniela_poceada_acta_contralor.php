...
$pozo_8_aciertos = (($row_rec->CANTIDAD_GANADORES_8 == 0) ? 'Pozo Vacante con 8 Aciertos' : ($row_rec->CANTIDAD_GANADORES_8 > 1 ? $row_rec->CANTIDAD_GANADORES_8 . ' Ganadores con $' . number_format(($row_rec->TOTAL_PREMIOS_8_ACIERTOS / $row_rec->CANTIDAD_GANADORES_8), 0, ',', '.') . ' c/u ' : $row_rec->CANTIDAD_GANADORES_8 . ' Ganador con $' . number_format(($row_rec->TOTAL_PREMIOS_8_ACIERTOS / $row_rec->CANTIDAD_GANADORES_8), 0, ',', '.')));
$pozo_7_aciertos = (($row_rec->CANTIDAD_GANADORES_7 == 0) ? 'Pozo Vacante con 7 Aciertos' : ($row_rec->CANTIDAD_GANADORES_7 > 1 ? $row_rec->CANTIDAD_GANADORES_7 . ' Ganadores con $' . number_format(($row_rec->TOTAL_PREMIOS_7_ACIERTOS / $row_rec->CANTIDAD_GANADORES_7), 0, ',', '.') . ' c/u' : $row_rec->CANTIDAD_GANADORES_7 . ' Ganador con $' . number_format(($row_rec->TOTAL_PREMIOS_7_ACIERTOS / $row_rec->CANTIDAD_GANADORES_7), 0, ',', '.')));
$pozo_6_aciertos = (($row_rec->CANTIDAD_GANADORES_6 == 0) ? 'Pozo Vacante con 6 Aciertos' : ($row_rec->CANTIDAD_GANADORES_6 > 1 ? $row_rec->CANTIDAD_GANADORES_6 . ' Ganadores con $' . number_format(($row_rec->TOTAL_PREMIOS_6_ACIERTOS / $row_rec->CANTIDAD_GANADORES_6), 0, ',', '.') . ' c/u ' : $row_rec->CANTIDAD_GANADORES_6 . ' Ganador con $' . number_format(($row_rec->TOTAL_PREMIOS_6_ACIERTOS / $row_rec->CANTIDAD_GANADORES_6), 0, ',', '.')));
$pdf->ln(7);
$pdf->SetX(25);
