...
$titulo = strtoupper('ACTA SORTEO DE QUINIELA ' . utf8_decode($_SESSION['juego_tipo']));
...
try {
    $rs_extracciones = sql("	SELECT TD.DESCRIPCION,LPAD(TE.NUMERO,4,0) AS NUMERO,TE.POSICION
