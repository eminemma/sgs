                ...
                <div class="navbar">
                    <div class="navbar-inner">
                        <ul class="nav juegos">
                            ...
                            <li>
                                <a href="#" class="ver_pozo_67_aciertos" onclick="cargar_juego(this.className); return false;"><img src="img/icono_screen.png" width="19" height="19" border="0" style="vertical-align: middle;">Pant. Pozos 7,6 y 5 Aciertos</a>
                            </li>
