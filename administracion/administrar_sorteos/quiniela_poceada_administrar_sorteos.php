...
<table class="table table-bordered">
	...
	<tbody>
			...
			<tr>
				...
				<td class="centerCell"><a href="#" onclick="g('administracion/administrar_sorteos/quiniela_poceada_modificar_sorteo.php?id_sorteo=<?php echo $row->ID_SORTEO ?>')" title="Modificar Sorteo"><div class="fa fa-pencil-square-o fa-2x"></div></a></td>
			</tr>
		<?php } ?>
	</tbody>
</table>